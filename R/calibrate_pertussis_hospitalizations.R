# Calibrate pertussis hospitalization model parameters using observed national level data 
# --------------------------------------------------------------------------

calibrate_pertussis_hospitalizations <- function(df) {
  ...
  # --------------------------------------------------------------------------
  suppressMessages(here::i_am("R/calibrate_pertussis_hospitalizations.R"))
  print("---b. calibrate_pertussis_hospitalizations.R")
