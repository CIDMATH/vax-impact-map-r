# Calibrate rotavirus hospitalization model parameters using observed national level data 
# --------------------------------------------------------------------------

calibrate_rota_hospitalizations <- function(df) {
  ...
  # --------------------------------------------------------------------------
  suppressMessages(here::i_am("R/calibrate_rota_hospitalizations.R"))
  print("---a. calibrate_rota_hospitalizations.R")
